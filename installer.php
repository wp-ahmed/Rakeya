...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210410_rakeya_f725bfc464ec749a3298_20210410152749_archive.zip';
	const ARCHIVE_SIZE		 = '76216523';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f725bfc-10152749';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v3.8.4.1==');
		self::log('----------------------------------------------------');
